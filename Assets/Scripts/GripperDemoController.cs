...
public class GripperDemoController : MonoBehaviour
{
    ...
    public BigHandState moveState2 = BigHandState.MovingDown;
    public BigHandState moveState3 = BigHandState.MovingUp;
    ...
    public void Move()
    {
        if (moveState2 == BigHandState.MovingDown)
        {
            ArticulationBody articulation = GetComponent<ArticulationBody>();
            ...
            //increment this y position
            float targetPosition = xDrivePostion + -(float)moveState2 * Time.fixedDeltaTime * speed;
    ...
    public void Move2()
    {
        if (moveState3 == BigHandState.MovingUp)
        {
            ArticulationBody articulation = GetComponent<ArticulationBody>();
            ...
            //increment this y position
            float targetPosition = xDrivePostion + -(float)moveState3 * Time.fixedDeltaTime * speed;
